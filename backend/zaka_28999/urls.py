...
admin.site.site_header = "zaka"
admin.site.site_title = "zaka Admin Portal"
admin.site.index_title = "zaka Admin"

# swagger
api_info = openapi.Info(
    title="zaka API",
    default_version="v1",
    description="API documentation for zaka App",
)
